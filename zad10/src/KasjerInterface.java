...
public interface KasjerInterface {
    /**
     * Rozliczenia zakupów polega na pobraniu z przekazanych pieniędzy
     * ceny i zwróceniu reszty. Wyliczając resztę należy uwzględnić
     * prawa matematyki, nierozmienialnych złotówek oraz chęć
     * minimalizacji traconych środków (kasjer zwraca nierozmienialne
     * złotówki tylko jeśli musi).
    ...
    /**
     * Metoda ustawia dostep do dostawcy poczatkowego stanu kasy.
     * Przekazanego dostawce należy odpytać o pieniądze w kasie i
     * ponawiać pytanie aż do uzyskania null.
